...
c.aliases.update({'rv': 'open -t https://text.recoveryversion.bible/list/list.htm'})
...
c.aliases.update({'sync': 'open -t http://localhost:8384'})
c.aliases.update({'immich': 'open -t http://rpi5:2283'})
c.aliases.update({'hugo': 'open -t http://localhost:1313'})
c.aliases.update({'pihole': 'open -t http://rpi4:80/admin'})
...
c.url.searchengines.update({'rv': 'https://text.recoveryversion.bible/list/list.htm?{}'})
